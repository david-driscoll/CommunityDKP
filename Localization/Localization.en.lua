...
core.L = {
  ...
  MAXDIFFROLL = "Roll difference",
  MAXDIFFTTDESC = "This is the maximum different between bidders total DKP for a roll off.",
  MAXDIFFTTWARN = "eg: If you want want to allow some more randomness you can set this to allow others a chance to roll off. Setting to 0 will only force a roll off in the case of a tie. Should be between 0 and 100.",
  UPGRADECOST = "Upgrade cost",
  UPGRADETTDESC = "This is the amount that will be charged for upgrade items.",
  UPGRADETTWARN = "eg: Allows you offer a lower cost charge for something that is less desired overall.",
  OFFSPECCOST = "Offspec cost",
  OFFSPECTTDESC = "This is the amount that will be charged for offspec items.",
  OFFSPECTTWARN = "eg: Allows you offer a lower cost charge for something that is not for the characters primary role.",
  ...
  BONUSROLLNOTACCEPTED = "Your roll was not accepted.",
  BONUSROLLALREADYROLLED = "Your have already rolled.",
  BONUSROLLOUTSIDERANGE = "Your roll was not accepted. You are not within range.",
  BONUSROLLPLEASEWAIT = "Your roll was not accepted. Rolls must happen after the bid timer finishes.",
  ...
  SPEC = "Spec",
  STANDBYOPTIN = "Waitlist Opt In",
  STANDBYOPTINBEGIN = " has been killed. Please post !wl add (or !wl add Mains_Name if on an alt, spelling must be precise.) to Guild chat to receive DKP. Opt in will expire in 120 seconds.",
  STANDBYOPTINEND = "Waitlist Opt in has expired for: ",
  STANDBYOPTINTTDESC = "Announce to guild after a boss is killed requesting those on waitlist to opt in by typing !wl add or !wl add NAME (if on an alt) into GUILD chat. Opt in session will remain open for two minutes. Waitlist list is cleared after each boss kill prior to announcement of kill.",
  STANDBYOPTINTTWARN = "If automatic DKP distribution on boss kill is active, the automatic distribution for the waitlist list will occur when the two minute opt in timer expires.",
  STANDBYWHISPERRESP1 = "has been added to waitlist.",
  STANDBYWHISPERRESP2 = "is already on waitlist.",
  STANDBYWHISPERRESP3 = "is invalid. Player not found.",
  STANDBYWHISPERRESP4 = "You have been added to the waitlist.",
  STANDBYWHISPERRESP5 = "You are already on the waitlist.",
  ...
  BROADCASTOFFICERBIDS = "Broadcast Bids to Officers",
  BROADCASTOFFICERBIDSTTDESC = "When activated, Officers will see all bids submitted in their bid interface. Turn off if you do not want players to see everyone's bids.",
  ...
  CHANGELOG1 = "CommunityDKP - v4.2.10-bcc",
